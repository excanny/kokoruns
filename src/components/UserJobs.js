...
import  { stateData } from "../nigeria-states-and-local-govts.js";
...
export class UserJobs extends Component {
    ...
    //     this.setState({states : this.state.states.find(state => cntry.name === e.target.value).states});
    // }
               ...
               <Modal.Body style={{ padding: '.5rem'}}>
                        ...
                        <div align="center" className="post-job-container w-100 m-0">
                            ...
                            <div className="post-job-location">
                                ...
                                <select id="state" name="states" value={this.state.states} onChange={this.handleChange}>
